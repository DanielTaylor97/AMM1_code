...
dt = 0.1917
t_n = 1e4 ##this will take about 3 hours
...
#    initConds[j, 0] = (0.6*j/linIC_density)%0.6
#    initConds[j, 1] = 0.6*np.floor(j/linIC_density)/linIC_density
#
#initConds = initConds - 0.3
